      ...
      <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content col-md-12">
              <div class="modal-header">
                  <h4 class="modal-title" id="myModalLabel">Editar Tipo Vehiculo</h4>
              </div>
              @if(!$errors->isEmpty())
                ...
                <form action="{{ route('editarTipoVehiculo') }}" class="form-group" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <input type="text" id="id_nombre_tipo_vehiculo_editar" name="nombre_tipo_vehiculo_editar" autocomplete="off" minlength="6"  placeholder="tipo vehiculo" required class="form-control md-2" value="{{ old('nombre_tipo_vehiculo_editar') }}"> 
